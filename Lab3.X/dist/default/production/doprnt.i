 ...
 *ap = __va_start();
 ...
 while((c = *f++)) {
  ...
  for(;;) {
   switch(*f) {
# 596 "C:\\Program Files (x86)\\Microchip\\xc8\\v2.10\\pic\\sources\\c90\\common\\doprnt.c"
   case '0':
    flag |= 0x04;
    f++;
    continue;
...
# 1138 "C:\\Program Files (x86)\\Microchip\\xc8\\v2.10\\pic\\sources\\c90\\common\\doprnt.c"
    ...
    if(flag & 0x04) {
     ...
     if(flag & 0x03)
      ...
      ((*sp++ = ('-')));
# 1194 "C:\\Program Files (x86)\\Microchip\\xc8\\v2.10\\pic\\sources\\c90\\common\\doprnt.c"
     while(width > 0) {
      ((*sp++ = ('0')));
      width--;
     }
...
# 1407 "C:\\Program Files (x86)\\Microchip\\xc8\\v2.10\\pic\\sources\\c90\\common\\doprnt.c"
  ...
  if(flag & 0x04) {
   ...
   if(flag & 0x03)
    ((*sp++ = ('-')));
# 1441 "C:\\Program Files (x86)\\Microchip\\xc8\\v2.10\\pic\\sources\\c90\\common\\doprnt.c"
   if(width)
    do
     ((*sp++ = ('0')));
    while(--width);
